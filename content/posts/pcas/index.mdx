...
[![Inspiration tweet](./inspiration_tweet.png)](https://twitter.com/MKBHD/status/1275122690618261511)
...
> ![Android device fragmentation](./android_device_fragmentation.png)
...
![Hosts & Peripherals](./hosts_and_periherals.svg)
...
![Multiplatform modules](./multiplatform_modules.svg)
...
![Home and select peripheral screenshots](./screen_home_and_select_peripheral.png)
...
![Encyrption setup and codeshare screenshots](./screen_encryption_setup_and_code_share.png)
...
[![Watch demo](./demo_preview_with_play.png)](https://www.youtube.com/watch?v=WMmtQLNYF-g/)
...
![High level architecture](./architecture_highlevel.svg)
...
![./PCAS1.svg](./multicast.svg)

```kotlin:title=src/components/post.kt
...
![Transport data flow](./transport_data_flow.svg)
...
![Example local ledger](./example_ledger.svg)
...
[![A2DP profile](./a2dp_profile.jpg)](https://www.slideshare.net/Thenmurugeshwari/bluetooth-profile)
2. **Headset (Headset Profile/Hands-Free Profile)**: These are bi-directional audio profiles usually used for phone calls.
[![A2DP profile](./hfp_profile.jpg)](https://www.slideshare.net/Thenmurugeshwari/bluetooth-profile)
...
![Audio blocks sequence](./PCASBlocksEmitter.svg)
...
![./ble-advertising-packet.png](./ble-advertising-packet.png)
...
[![./ble-advertising-channels-spectrum.png](./ble-advertising-channels-spectrum.png)](https://www.argenox.com/library/bluetooth-low-energy/ble-advertising-primer/)
...
![Bluetooth Core Specs Page 2223](./bluetooth_core_specs_page_2223.png)
...
![./BLE_Chipsets_Power.png](./BLE_Chipsets_Power.png)
