...
["No Silver Bullet — Essence and Accident in Software Engineering”]((https://citeseerx.ist.psu.edu/viewdoc/download;jsessionid=66C7A96880B0FF7BE4AA3A2E4E28392E?doi=10.1.1.117.315&rep=rep1&type=pdf)) is a famous software engineering paper written by Turing Award winner Fred Brooks in 1987. This post summarizes the key ideas.

1. The author likens software projects to [werewolves](https://en.wikipedia.org/wiki/Werewolf) (to the non-technical manager) — they usually start innocent and straightforward, but can morph into a monster of missed schedules, blown budgets, and flawed products.
...
### iii. Changeability
1. Software is frequently modified compared to other industries because:
...
### iv. Invisibility
1. Diagramming software structures are hard — they constitute several superimposed general directed graphs — for things like control flow, data flow, patterns of dependency, time sequence, name-space relationships.
...
### ii. Time-sharing
1. Time-sharing preserves immediacy, and hence enables one to maintain an overview of complexity.
...
1. Ada philosophy provided an advance — it's the philosophy of modularization, of abstract data types, of hierarchical structuring.
...
2. Brooks believes that the conceptual components of the task are now (1987) taking most of the time.
