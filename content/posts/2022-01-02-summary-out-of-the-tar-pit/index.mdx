...
> 2. This summary includes all quotes and key points only. You can read the paper [PDF](https://github.com/papers-we-love/papers-we-love/blob/master/design/out-of-the-tar-pit.pdf)
